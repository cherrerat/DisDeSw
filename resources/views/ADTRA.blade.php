...
@section('headerRuta')
    <div class="col-md-11 row">
        <h4 class="h4"><a href="">Administración de terminal</a> -> <a href="#">Afluencia en terminal</a></h4>
    </div>
@endsection()
    ...
    <div class="container col-md-6">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-sm-11 btnBuscar">
                    <button class="btn btn-success" id="btnReporte">Reporte</button>
                </div>
                {!! Form::close() !!}
            </div>
            <!--/Box body-->
